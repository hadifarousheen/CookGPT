...
const GptSuggestions = () => {
  ...
  return (
    <div className="absolute z-30 mt-[45%] md:mt-[15%] md:left-1/3 md:transform md:-translate-x-1/3 border border-white bg-black rounded-lg md:p-4 opacity-90">
